...
#define MAC_WIFI_DEBUGGING // don't open this
#undef MAC_WIFI_DEBUGGING
...
#define FLURRY_ENABLED
//If IDE Version > 1055 undef
#undef  FLURRY_ENABLED
...
#define SMFEXPORT __attribute__ ((visibility ("default")))
    ...
    #define ACTIONEVENT_LOGGING
		...
		#endif
    #endif
    #ifdef MAC_WIFI_DEBUGGING
        #define IOS_PLAYER
        #define SMARTFACE_IOS_EMULATOR
        #define DEBUGGER_PLAYER
        #define LOG_TO_FILE
        #define SPRAT_LOGGING
        #define ACTIONEVENT_LOGGING
